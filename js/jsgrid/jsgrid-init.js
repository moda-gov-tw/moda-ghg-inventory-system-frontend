...
! function(document, window, $) {
    ...
    $(document).ready(function($) {
        ...
        pageNavigatorPrevText: "&#8230;",
            ...
            fields: [
                ...
                { name: "商品名稱",  type: "text",  align: "center"},
                { name: "物質類別",type: "select", items: db.prowz, valueField: "Id", textField: "Name" , align: "center" },
                { name: "HFCs冷媒編號", type: "select", items: db.prohfcs, valueField: "Id", textField: "Name" , align: "center" },
    ...
    function() {
        ...
        pageNavigatorPrevText: "&#8230;",
                data: db.pro2,
                fields: [
                    { name: "編號", type: "rownumbers",  width: 50, align: "center",editable:false,},
                    ...
                    { name: "銷售量", type: "text",editrules:{required:true}, width: 100, align: "center" ,editable:false,},
                    { name: "庫存量", type: "text",editrules:{custom:true,required:false},width: 100, align: "center",editable:false, },
        ...
        pageNavigatorPrevText: "&#8230;",
                ...
                fields: [
                    ...
                    { name: "使用用途",  type: "select", items: db.proyt, valueField: "Id", textField: "Name" ,editable:true,},
        ...
        pageNavigatorPrevText: "&#8230;",
                ...
                fields: [
                    { name: "編號",type: "rownumbers",  width: 50, align: "center",},
                    { name: "HFCs冷媒編號", type: "select", items: db.prohfcs, valueField: "Id", textField: "Name" ,editable:true,},
                    { name: "年度回收量",type: "text", width: 100, align: "center" ,editable:true },
                    { name: "使用回收機台數",type: "text", width: 100, align: "center" ,editable:true },
                    { name: "廠內回收或廠外回收",type: "select", items: db.progc, valueField: "Id", textField: "Name" ,editable:true, },
                    { type: "control", editButton: true, modeSwitchButton: true }
                ]
            });
        }(),
        function() {
            $("#customgrid").jsGrid({
                ...
                fields: [
                    { name: "Account", width: 50, align: "center" },
                    { name: "Name", type: "text" },
